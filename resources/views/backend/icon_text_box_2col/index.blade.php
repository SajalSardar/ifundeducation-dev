...
@section('breadcrumb')
    <div data-kt-place="true" data-kt-place-mode="prepend"
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            ...
            <li class="breadcrumb-item text-dark">IconTextBox2col</li>
        </ul>
    </div>
@endsection
@section('content')
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">All IconTextBox2cols</span>
            </h3>
            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                title="" data-bs-original-title="Click to add a IconTextBox2col">
        ...
        <div class="card-body py-3">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                    ...
                    <!--begin::Table body-->
                    <tbody>
                        @isset($iconTextBox2Cols)
                            @foreach ($iconTextBox2Cols as $iconTextBox2Col)
                                <tr>
                                    <td>
                                        {{ $iconTextBox2Col->id }}
                                    </td>
        ...
        <div class="modal-dialog mw-650px">
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form action="{{ route('dashboard.settings.icon-text-box-2col.store') }}" method="POST">
                        @csrf
