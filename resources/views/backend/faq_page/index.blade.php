...
@section('content')
    <div class="card mb-5 mb-xl-8">
        ...
        <form action="{{ route('dashboard.pages.faq-page.update', $faqPage) }}" method="POST"
            ...
            <div class="card-header border-0 pt-5">
                ...
                <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                    title="" data-bs-original-title="Click to Update FAQ Page"
                                ...
                                @isset($faqPage)
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            ...
                                            @if ($faqPage->image)
                                                <img src="{{ asset('public/frontend/images/pages/' . $faqPage->image) }}"
                                                    width="200" alt="{{ $faqPage->image }}">
                                                <p>{{ $faqPage->image }} <a
                                                        href="{{ route('dashboard.pages.faq-page.image.delete', $faqPage) }}"
                                                        title="Delete [{{ $faqPage->image }}]"
                                                        onclick="return confirm('Are you sure you want to delete this Image? [{{ $faqPage->image }}]')"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" style="padding: 0"><input type="text"
                                                ...
                                                name="sub_title" value="{{ $faqPage->sub_title }}"></td>
                                    </tr>
                                    <tr>
                                        <td style="vertical-align: top">&nbsp;&nbsp;Text Before FAQ</td>
                                        <td style="vertical-align: top">&nbsp;:&nbsp;</td>
                                        <td colspan="2" style="padding: 0">
                                            <textarea name="text_before_faq" class="form-control  form-control-solid" rows="2"
                                                placeholder="Enter Text Before FAQ">{{ $faqPage->text_before_faq }}</textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="vertical-align: top">&nbsp;:&nbsp;</td>
                                        <td colspan="2" style="padding: 0">
                                            <textarea name="text_after_faq" class="form-control  form-control-solid" rows="2"
                                                placeholder="Enter Text After FAQ">{{ $faqPage->text_after_faq }}</textarea>
                                        </td>
                                    </tr>
                                @endisset
                            </tbody>
                                ...
                                @foreach ($faqs as $faq)
                                    <tr>
                                        <td style="white-space: nowrap; width: 118px;">
                                            ...
                                            <form
                                                onclick="return confirm('Are you sure you want to delete this record? [ID: {{ $faq->id }}]')"
                                                title="ID: {{ $faq->id }}" class="d-inline"
                                                action="{{ route('dashboard.pages.faq.delete', $faq) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm"
                                                    title="Delete [ID: {{ $faq->id }}]">
