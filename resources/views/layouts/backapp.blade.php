                ...
                <div class="aside-menu flex-column-fluid">
                    ...
                    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            <div data-kt-menu-trigger="click"
                                class="menu-item menu-accordion  {{ request()->routeIs('dashboard.theme-options.*') ? 'hover show' : '' }}">
                                <span class="menu-link">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-2">
                                            <svg width="24px" height="24px" viewBox="0 0 24 24">
                                ...
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    ...
                                    <div class="menu-item menu-accordion">
                                        <a href="{{ route('dashboard.theme-options.general') }}"
                                            class="menu-link
                                        {{ request()->routeIs('dashboard.theme-options.general') ? 'active' : '' }}
                                        ">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                ...
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    ...
                                    <div class="menu-item menu-accordion">
                                        <a href="{{ route('dashboard.theme-options.index') }}"
                                            class="menu-link
                                        {{ request()->routeIs('dashboard.theme-options.index') ? 'active' : '' }}
                                        ">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">Theme Settings</span>
                                        </a>
                                    </div>
