              ...
              <div class="col-12 mb-5">
                <ul class="nav nav-tabs" id="fundeducationTab">
                  ...
                  @if (auth()->user()->hasRole('fundraiser'))
                    <li class="nav-item">
                      <a href="#academic_profile" class="nav-link" data-bs-toggle="tab" data-bs-target="#academic_profile"
                        type="button">Academic Profile</a>
                    </li>
                  @endif
                  <li class="nav-item">
                    ...
                    <div class="row">
                      <div class="col-lg-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('fname') is-invalid @enderror"
                          value="{{ old('fname', auth()->user()->first_name) }}" id="fname" name="fname">
                        @error('fname')
                      ...
                      <div class="col-lg-6 mb-3">
                        ...
                        <input type="number" name="phone" value="{{ auth()->user()->personal_profile->phone ?? '' }}"
                      ...
                      <div class="col-lg-6 mb-3">
                        ...
                        <input type="date"
                          ...
                          class="form-control @error('birthday') is-invalid @enderror" id="date" name="birthday">
                        @error('birthday')
                          <p class="text-danger">{{ $message }}</p>
                        @enderror
                      </div>
                      ...
                      <div class="col-12 mb-3">
                        ...
                        <input type="text" placeholder="address"
                          ...
                          class="form-control @error('address') is-invalid @enderror" id="inputAddress" name="address">
                        @error('address')
                          <p class="text-danger">{{ $message }}</p>
                        @enderror
                      </div>
                      ...
                      <div class="col-lg-6 mb-3">
                        ...
                        <input type="text" value="{{ auth()->user()->personal_profile->zip_code ?? '' }}"
                          class="form-control @error('zip') is-invalid @enderror" id="inputZip" name="zip">
                        @error('zip')
                          <p class="text-danger">{{ $message }}</p>
                        @enderror
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-12 mb-3">
                          ...
                          <div class="collage_select">
                            <select id="inputcoll" class="select_2 @error('university') is-invalid @enderror"
                              name="university">
                        ...
                        <div class="col-lg-6 mb-3">
                          <label for="inputStudyMajor" class="form-label">Study Major:<span
                              class="text-danger">*</span></label>
                          <input type="text" class="form-control  @error('major_study') is-invalid @enderror"
                        ...
                        <div class="col-lg-6 mb-3">
                          ...
                          <select id="inputClassification"
                            class="select_2  @error('classification') is-invalid @enderror" name="classification">
                        ...
                        <div class="col-lg-6 mb-3">
                          ...
                          <select id="inputDegreeEnrolledIn" class="select_2  @error('degree') is-invalid @enderror"
                            name="degree">
                        ...
                        <div class="col-lg-6 mb-3">
                          <label for="schedule" class="form-label">Class
                            Schedule:</label>
                          <input class="form-control  @error('schedule') is-invalid @enderror" type="file"
                            name="schedule" placeholder="Class Schedule" id="schedule">
                          <label class="pt-1">
                          ...
                          @if (!empty(auth()->user()->academic_profile->schedule))
                            <div class="mt-2">
                              <img
                                src="{{ asset('storage/class_schedule/' . auth()->user()->academic_profile->schedule) }}"
                        ...
                        <div class="col-lg-6 mb-3">
                          ...
                          <input class="form-control  @error('transcript') is-invalid @enderror" type="file"
                            name="transcript" id="transcript" placeholder="Transcript">
                          <label class="pt-1">
                          ...
                          @if (!empty(auth()->user()->academic_profile->transcript))
                            <div class="mt-2">
                              <img
                                src="{{ asset('storage/transcript/' . auth()->user()->academic_profile->transcript) }}"
                    ...
                    <div class="row">
                      <div class="col-lg-6 mb-3">
                        ...
                        <input type="text" placeholder="Linkedin Url"
                          value="{{ old('linkedin', auth()->user()->userSocial->linkedin ?? '') }}" name="linkedin"
                          class="form-control @error('linkedin') is-invalid @enderror" id="inputlink">
                        @error('linkedin')
                          <p class="text-danger">{{ $message }}</p>
                        @enderror
                      </div>
                      <div class="col-lg-6 mb-3">
                        ...
                        <input type="text" placeholder="Instagram Url"
                          value="{{ old('instagram', auth()->user()->userSocial->instagram ?? '') }}" name="instagram"
                      ...
                      <div class="col-lg-6 mb-3">
                        ...
                        <input type="text" placeholder="Facebook Url"
                          value="{{ old('facebook', auth()->user()->userSocial->facebook ?? '') }}" name="facebook"
                      ...
                      <div class="col-lg-6 mb-3">
                        ...
                        <input type="text" placeholder="Twitter Url"
                          value="{{ old('twitter', auth()->user()->userSocial->twitter ?? '') }}" name="twitter"
                      ...
                      <div class="col-lg-6 mb-3">
                        ...
                        <input type="text" placeholder="Tiktok Url"
                          value="{{ old('tiktok', auth()->user()->userSocial->tiktok ?? '') }}" name="tiktok"
                      ...
                      <div class="col-lg-6 mb-3">
                        ...
                        <input type="text" placeholder="YouTube Url"
                          value="{{ old('youtube', auth()->user()->userSocial->youtube ?? '') }}" name="youtube"
                      ...
                      <div class="col-lg-6 mb-3">
                        ...
                        <input type="text" placeholder="snapchat Url"
                          value="{{ old('snapchat', auth()->user()->userSocial->snapchat ?? '') }}" name="snapchat"
                      ...
                      <div class="col-lg-6 mb-3">
                        ...
                        <input type="text" placeholder="Pinterest Url"
                          value="{{ old('pinterest', auth()->user()->userSocial->pinterest ?? '') }}" name="pinterest"
                          class="form-control @error('pinterest') is-invalid @enderror" id="pinterest">
                        @error('pinterest')
                          <p class="text-danger">{{ $message }}</p>
                        @enderror
                      </div>
                      <div class="col-lg-6 mb-3">
                        ...
                        <input type="text" placeholder="Website Url"
                          value="{{ old('website', auth()->user()->userSocial->website ?? '') }}" name="website"
