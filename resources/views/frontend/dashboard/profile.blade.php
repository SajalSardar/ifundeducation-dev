                            ...
                            <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('lname', auth()->user()->last_name) }}" id="lname"
                                                    name="lname">
                                                @error('lname')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                ...
                                @if (auth()->user()->hasRole('fundraiser'))
                                    <div class="tab-pane fade" id="academic_profile">
                                        <form method="POST"
                                            action="{{ route('user.profile.academic.update', auth()->user()->id) }}"
                                            class="account_content_area_form" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="row">
                                                <div class="col-lg-12 mb-3">
                                                    ...
                                                    <label class="form-label ms-5">
                                                        If not listed? Click Here <input type="checkbox"
                                                            id="onlistUniversity">
                                                    </label>
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    <label for="inputClassification"
                                                        class="form-label">Classification:<span
                                                            class="text-danger">*</span></label>
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <select id="inputDegreeEnrolledIn"
                                                        class="select_2  @error('degree') is-invalid @enderror"
                                                        name="degree">
                                ...
                                <div class="tab-pane fade" id="social_profile">
                                    <form method="POST"
                                        action="{{ route('user.profile.social.upload', auth()->user()->id) }}"
